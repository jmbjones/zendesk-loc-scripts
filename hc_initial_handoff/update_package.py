...
def main():
    ...
    for locale in locales:
        ...
        for file in files:
            ...
            url = 'https://{}.zendesk.com/api/v2/help_center/articles/{}/translations/{}.json'.format(subdomain, file[path_len:-5], locale)
            put_translation(payload, url, session)
...
def create_payload(locale, file):
    ...
    data = {'translation': {'title': title, 'body': str(tree)}}
    return json.dumps(data)

def put_translation(payload, url, session):
